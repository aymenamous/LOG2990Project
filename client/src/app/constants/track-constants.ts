...
export const WALL_HEIGHT: number = -95;
export const WALL_WIDTH: number = -105;
export const VERTICES_3: number = 3;
export const VERTICES_4: number = 4;
export const VERTICES_5: number = 4;
export const VERTICES_6: number = 6;
export const VERTICES_7: number = 7;
